...
from normalize.lanl_proc import normalize_lanl_proc_line
...
def main():
    ...
    proc_path = "data/raw/proc_sample.txt"
    out_path = "data/normalized/lanl_proc_events.jsonl"

    events = []
    counts = Counter()
    parse_failures = 0

    for line, meta in read_lines(proc_path, source="lanl_proc", encoding="utf-8"):
        ev = normalize_lanl_proc_line(line)
    ...
    print("=== LANL Process Integration Test ===")
    print(f"Input file: {proc_path}")
