...
from normalize.lanl_dns import normalize_lanl_dns_line
...
def main():
    ...
    dns_path = "data/raw/dns_sample.txt"
    out_path = "data/normalized/lanl_dns_events.jsonl"

    events = []
    counts = Counter()
    parse_failures = 0

    for line, meta in read_lines(dns_path, source="lanl_dns", encoding="utf-8"):
        ev = normalize_lanl_dns_line(line)
    ...
    print("=== LANL DNS Integration Test ===")
    print(f"Input file: {dns_path}")
